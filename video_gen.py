...
if __name__ == "__main__":
    ...
    # try:
    #     result = gen.generate(
    #         prompt="create a video based on this reference image",
    #         model="veo_3_1-fast",
    #         size="720x1280",
    #         images=["test/1.png"],
    #         save_path="test_videos/test1_ref1.mp4"
    #     )
    #     print(f"✅ 成功: {result}")
    # except Exception as e:
    #     print(f"❌ 失败: {e}")
    ...
    # try:
    #     result = gen.generate(
    #         prompt="create a video combining these two reference images",
    #         model="veo_3_1-fast",
    #         size="720x1280",
    #         images=["test/1.png", "test/2.png"],
    #         save_path="test_videos/test2_ref2.mp4"
    #     )
    #     print(f"✅ 成功: {result}")
    # except Exception as e:
    #     print(f"❌ 失败: {e}")
    ...
    try:
        result = gen.generate(
            prompt="create a video based on these three reference images",
            model="veo_3_1-fast",
            size="720x1280",
            images=["test/1.png", "test/2.png", "test/3.png"],
            save_path="test_videos/test3_ref3.mp4"
        )
        print(f"✅ 成功: {result}")
    except Exception as e:
        print(f"❌ 失败: {e}")
